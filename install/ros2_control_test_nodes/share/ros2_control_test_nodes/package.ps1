...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\../../build/ros2_control_test_nodes/share/ros2_control_test_nodes/hook/pythonpath_develop.ps1"
