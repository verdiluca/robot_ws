...
#---------------------------------------------------------------------LOGICA_PROTO-----------------------------------------------------------------------------#
    def Logica_Proto(self):
        ...
        # if logica_proto == 33:
        #     start_time = time.time()
        #     logica_proto = 44 #era 2


        # if logica_proto == 44:
        #     if (time.time() - start_time) >= 2.5:
        #         logica_proto = 1 #era 2
        #------------------------------------------------#
...
#-----------------------------------------------------------LOGICA_CONTROLLO_SENSORI_PARTENZA------------------------------------------------------------------#
    ...
    def Logica_Controllo_Sensori_Partenza(self):
        ...
        if logica_controllo_sensori_partenza == 2 and (n < 0.35 or no < 0.35 or ne < 0.35 or e < 0.35 or o < 0.35) and (n > 0 and ne > 0 and no > 0 and e > 0 and o > 0):
        ...
        if logica_controllo_sensori_partenza == 3 and TIMER DI UN SECONDO:
            logica_controllo_sensori_partenza = 2
...
#-------------------------------------------------------------------------LOGICA_STERZO_DX----------------------------------------------------------------------#
    ...
    def Logica_Sterzo_DX(self):
        ...
        if logica_sterzo_dx == 2 and no > 0.55 and o > 0.55:
            logica_sterzo_dx = 3
        elif logica_sterzo_dx == 2 and (no < 0.55 or o < 0.55):
            logica_sterzo_dx == 1
...
#-------------------------------------------------------------------------LOGICA_STERZO_SX----------------------------------------------------------------------#
    ...
    def Logica_Sterzo_SX(self):
        ...
        if logica_sterzo_sx == 2 and e > 0.55 and ne > 0.55:
            logica_sterzo_sx = 3
        elif logica_sterzo_sx == 2 and (ne < 0.55 or e < 0.55):
            logica_sterzo_sx == 1
